...
*/
     ...
     */
    fun View.checkBoxMaterial(id: Int): MaterialCheckBox {
    ...
    fun startAnimation(
        ...
        /*valueAnimator.addListener(object : Animator.AnimatorListener {
            ...
            override fun onAnimationEnd(p0: Animator?) {
                ...
                // Navigate to com.awzpact.identify.newwork.main activity on navigation end.
            }
    ...
    fun getDateAgoTime(dateFormat: String, date: String?): String? {
        ...
        if (date?.isNotEmpty() == true) {
            ...
            if (seconds < 60) {
                finalInput = "less then 1 minute ago"//seconds.toString() + " Seconds ago"
            } else if (minutes < 60) {
    ...
    fun getTimeForCurrentDate(stringDate: String): String? {
        ...
        returnValue = if (calendarDate >= midnight) {
            val timeFormat = SimpleDateFormat("HH:mm")
            timeFormat.format(date)
        } else {
            val dateTimeForm = SimpleDateFormat("MMM dd")
            dateTimeForm.format(date)
        }
    ...
    fun getMilliSecondsToTimeAndDate(stringDate: String?): String? {
        var returnValue: String? = null
        val inputFormat = SimpleDateFormat("EEE MMM dd HH:mm:ss zzzz yyyy")
        val date = inputFormat.parse(stringDate)
        val calendarDate = Calendar.getInstance()
        calendarDate.time = date
        val dateTimeForm = SimpleDateFormat("dd/MM/yyyy HH:mm:ss")
